...
export const DragHandle = ({ className }: { className?: string }) => {
  return (
    <div
      data-swapy-handle
      className={cn(
        "absolute top-2.5 right-2.5 z-20 cursor-grab text-zinc-400 hover:text-white p-1 rounded-lg bg-zinc-900/80 border border-white/10 active:cursor-grabbing backdrop-blur-md opacity-0 group-hover:opacity-100 transition-all duration-200",
        className
      )}
    >
      <svg
        ...
        className="lucide lucide-grip-vertical-icon opacity-80"
      >
...
export const SwapySlot = ({
  ...
  return (
    <div
      className={cn(
        "transition-colors duration-200 rounded-3xl data-[swapy-highlighted]:bg-cyan-500/10 data-[swapy-highlighted]:ring-2 data-[swapy-highlighted]:ring-cyan-400/40",
        className
      )}
      data-swapy-slot={id}
    >
...
export const SwapyItem = ({
  ...
  return (
    <div
      className={cn(
        "data-[swapy-dragging]:shadow-2xl data-[swapy-dragging]:shadow-cyan-500/30 data-[swapy-dragging]:scale-[1.02] transition-transform",
        opacityClass,
        className
      )}
      data-swapy-item={id}
